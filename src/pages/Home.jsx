...
const Home = () => {
  return (
    <>
    <Header/>
    <div className='py-34  px-20 bg-gray-300 dark:bg-gray-900 text-gray-800 dark:text-gray-300 h-full'>
    ...
    <div className='pt-10 pb-40  px-20 bg-gray-300 dark:bg-gray-900 text-gray-800 dark:text-gray-300 h-full'>
    ...
    <div className='px-20 bg-gray-300 dark:bg-gray-900 text-gray-800 dark:text-gray-300 h-ful'>
      ...
      <div className='py-4'> 
            <ul className='flex justify-center space-x-6 text-blue-400 text-base md:text-2xl '>
                ...
                <li className='hover:text-gray-800 dark:hover:text-gray-50'><a href="" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-whatsapp"></i></a></li>
            </ul>
        </div> 
    </div>
    <Footer />
